...
const CANONICAL_SPECIALIZATIONS = [
  ...
  "Dept of ECE (Data Science)",
  "Dept of ECE (Cyber Physical Systems)",
  "Dept of ECE (VLSI Design)",
  "Dept of Electronics and Computer Engineering",
  "Dept of ECE (M.Tech Integrated)",
  "Dept of CSE",
  "Dept of IT",
  "Dept of Mechanical",
  "Dept of Biomedical",
...
async function migrateProjects() {
  console.log("🔍 Fetching existing projects from database...");
